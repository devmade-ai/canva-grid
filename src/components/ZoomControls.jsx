...
export default function ZoomControls({ zoomLevel, autoScale, onZoomChange }) {
  ...
  return (
    <div className="inline-flex items-center gap-0.5 sm:gap-1 bg-zinc-50 dark:bg-dark-subtle rounded-lg border border-zinc-200/60 dark:border-zinc-700/60 px-0.5 sm:px-1 py-0.5">
      <button
